$(function () {
	...
	.bind('DRPEx-change', function (event, obj) {
		...
		// {
		// 		[start: (Date object of the earlier date),]
		// 		[end: (Date object of the later date),]
		// or
		// 		[date: (Single date object)]
		// }
	})
	...
	$('#two-inputs').dateRangePicker({
		...
		setValue: function (s, s1, s2) {
			$('#date-range200').val(s1[1]);
			$('#date-range201').val(s2[1]);
		}
	});
	...
	$('#date-range16').dateRangePicker({
		...
		alert('start: ' + obj.start + ' / end: ' + obj.end);
	});
	...
	$('#date-range16-set').click(function (evt) {
		evt.stopPropagation();
		$('#date-range16').data('DRPEx').setRange('2013-11-20', '2014-08-25');
	});
	$('#date-range16-set-silent').click(function (evt) {
		evt.stopPropagation();
		$('#date-range16').data('DRPEx').setRange('2014-11-03', '2015-02-12', true);
	});
	...
	$('#date-range16-reset').click(function (evt) {
		evt.stopPropagation();
		$('#date-range16').data('DRPEx').resetView();
	});
